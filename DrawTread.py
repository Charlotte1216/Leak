...
python DrawTread.py --seed 42 --agent-algorithm dqn --network-type ffnn --marl-algorithm qmix --lr 0.0001 --gamma 0.9 --batch-size 32
还不错哦
python DrawTread.py --seed 42 --agent-algorithm ppo --network-type lstm --marl-algorithm mappo --lr 0.00001 --gamma 0.9 --batch-size 64
python DrawTread.py --seed 42 --agent-algorithm ppo --network-type transformer --marl-algorithm mappo --lr 0.00001 --gamma 0.9 --batch-size 32
"""
